...
In essence, the simplest class of graphs is completely defined by a set of vertices and edges.
...
That means that the network density is given by:

$$
density(G) = \frac{edges(G)}{\frac{nodes(G)(nodes(G) - 1)}{2}}
$$
